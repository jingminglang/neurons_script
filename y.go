...
func main() {
	...
	//m["a"] = "dd1"
	//m["b"] = "dd4"
	//Eval(`if a eq  "dd1" then b = "dd3" fi`,m)
	//read := strings.NewReader(os.Args[1])
	Eval(os.Args[1], m)
	fmt.Println("%#v", m)
	//fmt.Println("%#v", symTab)
	//fmt.Println("%#v", my)
	//log.Println(prog)
	//if prog == nil {
	//	os.Exit(1)
